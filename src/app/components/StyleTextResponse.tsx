    ...
    <>
      {aiResponseInitialized ? (
        <TypeAnimation
          ...
          wrapper="p"
          speed={99}
          className="text-body-primary dark:text-secondary font-medium text-body mt-6"
        />
      ) : (
        <p className="text-body-primary dark:text-secondary font-medium text-body mt-6">
          {aiResponse}
        </p>
      )}
    </>
